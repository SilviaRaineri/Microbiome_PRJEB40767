...
ogtt <- read.delim(file=ogtt, sep=",") # Do not scale for stats
ogtt$sample <- paste0(ogtt$Number, ogtt$Group)
ogtt <- reshape2::melt(ogtt, id.vars = c("Number","Group", "Bleed_Order","Day.1_Bw1","Cohort", "sample"))
ogtt$set <- "Insulin"
ogtt$set[grep("GLC", ogtt$variable)] <- "Glucose"
...
treatments = list( b = FK506, c= Bupropion , d=Naltrexone, e=FK506_Bupropion, f=FK506_Naltrexone, g=Bupropion_Naltrexone, h =Sibutramine)
## Anova on Glucose
