...
library(tidyverse)
# All weights
weight.chart <- read.delim('./Data/weigths_cohort1.csv', sep = ',')
...
species <- read.delim('../Nick_Analysis/combined_counts.dir/species_combined_counts.tsv') # NB! No species data about samples   '48'  '50'  '54'  '50H' 
...
tax <- readxl::read_xlsx('../Nick_Analysis/combined_counts.dir/species_tax.xlsx')
tax <- as.matrix(tax)
